...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:
        productos_iniciales = [
            # --- PERROS ---
            ("Alimento Seco Perros", 25000, "Bolsa de 15kg premium", "/static/img/perro01.png", "Perros"),
            ("Juguete Hueso", 4500, "Resistente para mordeduras", "/static/img/perro2.png", "Perros"),
            ("Cama Acolchada", 18500, "Cama grande lavable", "/static/img/perro03.png", "Perros"),
            ("Correa Extensible", 8200, "Correa de 5 metros", "/static/img/perro04.png", "Perros"),
            ("Shampoo Canino", 3500, "Shampoo neutro 500ml", "/static/img/perro05.png", "Perros"),
            ("Plato Doble", 6000, "Comedero/bebedero de acero", "/static/img/perro06.png", "Perros"),

            # --- GATOS ---
            ("Alimento Gatos", 18000, "Bolsa de 10kg sabor pescado", "/static/img/gato01.png", "Gatos"),
            ("Rascador Multinivel", 12000, "Rascador con cueva", "/static/img/gato02.png", "Gatos"),
            ("Piedras Sanitarias", 6500, "Piedras 4kg", "/static/img/gato03.png", "Gatos"),
            ("Juguete Ratón", 2200, "Ratón con catnip", "/static/img/gato04.png", "Gatos"),

            # --- OTROS ---
            ("Alimento Aves", 3200, "Semillas variadas 1kg", "/static/img/otros01.png", "Otros"),
            ("Pecera Completa", 22000, "Pecera de vidrio con filtro", "/static/img/otros02.png", "Otros")
        ]
